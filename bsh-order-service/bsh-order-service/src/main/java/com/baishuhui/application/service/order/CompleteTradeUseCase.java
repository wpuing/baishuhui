...
public class CompleteTradeUseCase {
    ...
    public Result<TradeOrderDTO> execute(CompleteTradeCommand cmd) {
        ...
        log.info("feign supply complete supplyId={} orderId={}", order.getSupplyId(), order.getId());
        ...
        if (completeRes == null || !ErrorCode.OK.equals(completeRes.getCode())) {
            log.warn("feign supply complete fail supplyId={} orderId={} code={} msg={}",
                    order.getSupplyId(), order.getId(),
                    completeRes == null ? null : completeRes.getCode(),
                    completeRes == null ? "null response" : completeRes.getMessage());
        ...
        tradeNotifyHelper.tradeCompleted(order);
        log.info("trade complete orderId={} supplyId={} operatorId={}",
